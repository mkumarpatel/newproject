                ...
                <!-- post-container --><div class="post-container">
                    <?php 
                     error_reporting(0);
                      ...
                      $cat_name="SELECT * FROM user  Where user_id= '$auth_id'";
                      $result=mysqli_query($conn,$cat_name);
                      $fetch=mysqli_fetch_assoc($result);
                    ?>
                  <h2 class="page-heading"><?php echo $fetch['username']?></h2>
                        <?php 
                      ...
                      LEFT JOIN user ON post.author = user.user_id WHERE post.author='$auth_id' ORDER BY post.post_id DESC";      
